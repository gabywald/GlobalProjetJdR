...
\newcommand{\colorcoeu}{ \includegraphics[width=1.40cm, height=1.40cm]{../../tarotData/img/color_coeur.jpg} }
\newcommand{\colorpiqu}{ \includegraphics[width=1.40cm, height=1.40cm]{../../tarotData/img/color_pique.jpg} }
\newcommand{\colortref}{ \includegraphics[width=1.40cm, height=1.40cm]{../../tarotData/img/color_trefle.jpg} }
...
\newcommand{\elementter}{ \includegraphics[width=1.40cm, height=1.40cm]{../../tarotData/img/element_earth.jpg} }
\newcommand{\elementfeu}{ \includegraphics[width=1.40cm, height=1.40cm]{../../tarotData/img/element_fire.jpg} }
\newcommand{\elementeau}{ \includegraphics[width=1.40cm, height=1.40cm]{../../tarotData/img/element_water.jpg} }
...
\begin{longtable}[ht]{ l l l }
	...
	\Ovalbox{%
		\begin{tabular}[ht]{ @{}m{4.50cm}@{} @{}p{1.50cm}@{} }
			\multirow{ 7 }{4.45cm}{ \includegraphics[width=4.45cm, height=9.00cm]{../../tarotData/img/3_LImperatrice.jpg} \vfill } 
											&	\tricurve		\\
											&	\colorcarr		\\
											&	\colorinte		\\
											&	\elementair		\\
	...
	\Ovalbox{%
		\begin{tabular}[ht]{ @{}m{4.50cm}@{} @{}p{1.50cm}@{} }
			\multirow{ 7 }{4.45cm}{ \includegraphics[width=4.45cm, height=9.00cm]{../../tarotData/img/4_LEmpereur.jpg} \vfill } 
											&	\tricurve		\\
											&	\colorcarr		\\
											&	\colorinte		\\
											&	\elementair		\\
