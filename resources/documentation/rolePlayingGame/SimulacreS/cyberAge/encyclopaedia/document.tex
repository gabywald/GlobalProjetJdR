...
Si vous avez des remarques {\`a} faire, des questions {\`a} poser ou des suggestions {\`a} offrir, vous pouvez {\'e}crire par courrier {\'e}lectronique {\`a} Pierre Rosenthal~\footnote{\texttt{rosen@francenet.fr}}. Ou {\`a} l'auteur du pr{\'e}sent document (voir ci-dessous). ~\\ 
...
\emph{<<{\'E}dition actuelle>> et pr{\'e}sent document --- \dateToday --- Gabriel Chandesris}. ~\\
...
\part*{Ajouts Technologies Impactants\markboth{Ajouts Technologies Impactants}{Ajouts Technologies Impactants}}
\addcontentsline{toc}{part}{Ajouts Technologies Impactants}
...
\begin{itemize}
	...
	\item \imgCABDBD \emph{Dallas Barr}, Marvano et Haldeman, Lombard.
\end{itemize}
...
D'autres applications ? Point central de vos connections cybern{\'e}tiques, dot{\'e} de prises standardis{\'e}es et normalis{\'e}es. On recense {\'e}galement des cas d'utilisation pour une connection permanente au cyberespace, du virtuel tout en {\'e}tant ancr{\'e} dans le r{\'e}el, sans liaison montante ou descendante autre que ce cortex artificiel ! Seules limitations : ce que la l{\'e}galit{\'e} peut bien pr{\'e}tendre dans les pays o{\`u} cette technologie s'applique (interdiction d'activation de plsuieurs copies simultan{\'e}es d'une m{\^e}me personne, par exemple). 
