...
2080;CyberPunk2077;TheSprawl;TechNoir;2103;%
}
...
Si vous avez des remarques {\`a} faire, des questions {\`a} poser ou des suggestions {\`a} offrir, vous pouvez {\'e}crire par courrier {\'e}lectronique {\`a} Pierre Rosenthal~\footnote{\texttt{rosen@francenet.fr}}.~\\
