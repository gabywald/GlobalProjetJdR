...
%% 				Esprit, double de l'esprit humain.
		...
		\item[\textbf{R{\'e}tro-Synchronicit{\'e} (RS)}]
		...
		\item[\textbf{Singularit{\'e} ou effet RS}]
...
\begin{tabular}[c]{c c c c c}
	...
	Famille			&	Symbole			&	{\'E}l{\'e}ment	& 	Type / Groupe... ou Id{\'e}al (?)		& "Pouvoirs"			\\
	Arcanes			&	Nb et Nom		&	-- selon --		&	Magie (?) ...							& ... 					\\
	B{\^a}tons		&	Carreaux		&	Air				&	Sociabilit{\'e}, Charisme ; Sant{\'e}	& Social / Relation 	\\
	Coupes			&	C\oe ur			&	Eau				& 	Vie, Gu{\'e}rison ; Ing{\'e}nierie		& Mat{\'e}riel			\\
	Deniers			&	Piques			&	Terre			& 	Protection, R{\'e}flexion ; Fortune		& Virtuel / Intellect	\\
	{\'E}p{\'e}es	&	Tr{\`e}fles		&	Feu				& 	Pouvoir, Unification ; Action			& Temporel / Religieux	\\
	
	% & Famille "CyberPunk" (?)
	% & Magie (?) ; Hasard ... 
	% & Gangs, Nomades...
	% & Tech, MedTech... 
	% & Solos, Fixers, Hackers...		
	% & Corporations, {\'E}tats...	
...
\begin{minipage}[ht]{0.45\textwidth}
	...
	\begin{itemize}
		\item[Arcanes] (ou Atouts) : magie
		\item[B{\^a}tons] (ou Carreau) : sant{\'e}
		\item[Coupes] (ou Coeurs) : charme
		\item[Deniers] (ou Tr{\`e}fles) : fortune
		\item[Ep{\'e}es] (ou Pique) : action
	\end{itemize}
	
	\emph{Le ma{\^i}tre du jeu a une seule main utilis{\'e}e pour l'ensemble des personnages non joueurs.}
...
\chapter{GiscardPunk}
	...
	\begin{center}
		...
		~\vfill
		\includegraphics[width=0.75\textwidth]{../../../imgGraphics/giscardpunk/Giscardpunk3.jpeg}~\\
	\end{center}
...
\begin{minipage}{0.45\linewidth}
	...
	\emph{Maquette de Paris par le Corbusier}
...
\begin{minipage}{0.45\linewidth}
	...
	\emph{Vision Glorieuse d'un Pass{\'e} R{\'e}volu ?}
	%% \caption{Une Vision Glorieuse du Passé ?}
	%% \end{figure}
\end{minipage} %% ~\\
...
Ce n'est pas CyberPunk 2020 ni m{\^e}me CyberPunk 2077 : c'est du \textbf{GiscardPunk}, et ça se passe en 1977 ! Bienvenue dans un R{\'e}troPunk qui fonctionne au Diesel, au Minitel et {\`a} la poussi{\`e}re de B{\'e}ton !~\\
...
% \end{minipage}
	...
	Le b{\'e}ton a un peu vieillit, l'essence co{\^u}te plus cher, les routes ne sont pas entretenues, les constructions non plus. La publicit{\'e} recouvre tout ceci afin de maintenir l'illusion d'une {\'e}conomie de march{\'e} florissante ! Pas ou peu d'innovations ici : c'est une "soci{\'e}t{\'e} glorieuse" qui continue dans sa lanc{\'e}e ! L'administration et les entreprises s'occupent de vos emplois et de besoins en biens de consommation ! Qui se soucie r{\'e}ellement d'aller au-del{\`a} de la maintenance ?~\\
	\emph{<<Cela a toujours fonctionn{\'e} ainsi !>>}
...
\textbf{Transports} : Grande Vitesse (le fameux TGV), le métro, le RER et ses gares monumentales !~\\

\textbf{Télécommunications} : complémentaire au téléphone, le fameux et incomparable \textsc{Minitel}, avec affichage en couleurs !~\\
